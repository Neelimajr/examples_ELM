function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy, Y, TY] = ELM(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
